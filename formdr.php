...
<div id="led">
  <h1 style="text-align: center;">  حساب شركات توصيل</h1>
...
<div id="b"><input type="" name="namem">اسم الشركة</div> <br>
...
echo "لم تقم بلموافقة على شروط الاستخدام";
  ...
  $user_check_query = "SELECT * FROM userc WHERE idp='$id' OR (idm='$idm') or (phon='$phon') LIMIT 1";
  ...
  if (count($errors) == 0 && $nam !='admin') {
    ...
    $query = "INSERT INTO `userc`(`id`, `name`, `namem`, `location`, `phon`, `telp`, `idp`, `idm`, `pasword`, `mony`,`stat`,`term`,`email` ) VALUES (NULL, '$nam', '$namm','$loc', '$phon', '$tel', '$id','$idm', '$paswordd','0','sal','$accpt','$email' );";
        echo " تم التسجيل بنجاح";
     mysqli_query($conn, $query);

$queryu = "SELECT * FROM `userc` where 1;";
        echo " تم التسجيل بنجاح";
