...
<a href="notf.php"><div id="b" style="text-align: center;">الاشعارات  
	...
	<a href="reqreservation.php"><div id="b" style="text-align: center;">
 
 طلبات الحجز</div></a>
<a href="reservations.php"><div id="b" style="text-align: center;"> الحجوزات</div></a>

<a href=" fdoc.php"><div id="b" style="text-align: center;">   معلومات العيادة</div></a>	 
...
if($picture_type=="image/jpeg" || $picture_type=="image/jpg" || $picture_type=="image/png" || $picture_type=="image/gif")
{
  ...
  echo $pic_name;
$sqli = "UPDATE `userd` SET `img` = '$pic_name' WHERE `id` = $id;";
