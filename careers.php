...
<h1 style="text-align: center;">إعلانات وظائف</h1>
<br>
<br>
<br>
...
$sql = "SELECT * FROM `add` where `type`='careers';";
...
if (mysqli_num_rows($result) > 0) {
 ...
 echo '<div id="not" style= "margin-right: 10%;margin-lift: 10%; width:30%;height:200px;margin-bottom:50px;overflow: hidden;text-align: center;  ">
