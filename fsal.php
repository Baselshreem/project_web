...
<br>
<div id="b"><input type=" " name="name"> اسم   المحل</div> <br>
...
if (isset($_POST['reg_user'])) {
  ...
  // Finally, register user if there are no errors in the form
    ...
    $query = "INSERT INTO `infsal`(`id`, `idd`, `name`, `contry`, `stret`, `betwen`, `phone`, `telp`, `days`, `hour`) VALUES (NULL, '$id', '$name','$contry','$bet','$loc', '$phon', '$tel', '$day','$tim' );";
