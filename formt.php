...
<div id="led">
  <h1 style="text-align: center;">  تسجيل مكتب تكسي</h1>
...
<div id="b"><input type="" name="namem">اسم المكتب </div> <br>
...
echo "لم تقم بلموافقة على شروط الاستخدام";
  ...
  $user_check_query = "SELECT * FROM usert WHERE idp='$id' OR (idm='$idm') or (phon='$phon') LIMIT 1";
  ...
  if (count($errors) == 0 && $nam !='admin') {
    ...
    $query = "INSERT INTO `usert`(`id`, `name`, `namem`, `location`, `phon`, `telp`, `idp`, `idm`, `pasword`, `mony`,`stat`,`term`,`email`) VALUES (NULL, '$nam', '$namm','$loc', '$phon', '$tel', '$id','$idm', '$paswordd','0','tix','$accpt','$email');";
