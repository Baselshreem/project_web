...
<a href="notft.php"><div id="b" style="text-align: center;">الاشعارات  
            <div style="display: none;"> <?php include("notft.php") ?></div><?php echo $count; ?>
        </div></a>
...
<a href="rt.php"><div id="b" style="text-align: center;">طلب تكسي
        ...
        <a href="driv.php"><div id="b" style="text-align: center;"> اسماء السائقين </div></a>
	<a href="baskett.php"><div id="b" style="text-align: center;"> طلبات توصيل</div></a>
...
if($picture_type=="image/jpeg" || $picture_type=="image/jpg" || $picture_type=="image/png" || $picture_type=="image/gif")
{
  ...
  echo $pic_name;
$sqli = "UPDATE `usert` SET `img` = '$pic_name' WHERE `id` = $id;";
